    ...
    $('#date_slider').slider({
	    ...
	    //ui is the slider value 1 to 5
            ...
            // Changing the label to the selected monthname
       	    newui = ((ui.value + 9) % 12);
            //newui 1-5 to 11,12,1,2,4
            //newui 3 to 7 Mar to July
            //newui 11,12,1,2,3 ie Nov to Mar
            if (newui === 0) {
                newui = 12;
            }
...
$(document).ready(function () {
    ...
    ui = setUI2((d1.getMonth()) + 1,10); //month 1-12, start slider in June
