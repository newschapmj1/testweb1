...
var now       = new Date();
var thisMonth = now.getMonth() + 1 - offset; //month 0-11  -> range on slider 1..5, 1..6 etc
var thisMonth2 = now.getMonth()+1; //1-12   eg 8-offset ->ui eg Aug =2
var newui = (offset + thisMonth2) % 12;
$('#selected_month').html(monthName( now.getMonth() + 1));
    $('#date_slider').slider('value',thisMonth);
    //ui 1..5,1..6
