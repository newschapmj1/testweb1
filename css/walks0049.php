...
<div class="row">
 <div class="col-sm-8 col-sm-offset-2">
  <p class="text-center"><a href="walks_getting_there.php">Walks - getting there</a>&nbsp;&nbsp;&nbsp;<a href="directions.php">Directions</a></p>
</div>
</div>
</div>
<br>
...
<div class="container">
     <div class="row">
        <div class="col xs-6 col-sm-2 col-md-offset-1">Date</div>
        <div class="col xs-6 col-sm-2">Details</div>
        <div class="col xs-6 col-sm-2">Map</div>
        <div class="col xs-6 col-sm-6 col-md-4">Description</div>
      </div>
      <br>
</div>
...
print("<div class=\"container\">");
  ...
  //                                print("<br><div class=\"row\"><p>".$formatteddate."</p></div><br>");
                                  //print("<hr>");
                                  print("<div class=\"col-sm-offset-1 sm-2\"><p>".$formatteddate."</p></div><hr>");
                        ...
                        if ($old!="Old") 
                                {
                                    ...
                                    //col 1 of 4
                                    print("<div class=\"col-xs-6 col-sm-2 col-md-offset-1\"><p>".$formatteddatetime."<p></div>");
                                    //print("</td>");
                                    //print("<td>$row[briefdescription]<br><br>Miles: $row[miles]"."  ".routeType($row[routetype])."<br><br>Grade: ".walkCode($row['grade']));
                                    
                                    //col 2 of 4
                                    print("<div class=\"col-xs-6 col-sm-2\"><p>".$row[briefdescription]."</p><p>Miles: ".$row[miles].",  ".
                                      routeType($row[routetype])."</p><p>Grade: ".walkCode($row['grade'])."</p></div>");
                                    //print("</td>");
                                    ...
                                    */
                                    ...
                                    print("<div class=\"col-xs-6 col-sm-2\"><p><a href=\"http://streetmap.co.uk/grid/$mapgridref\" target=\"_blank\" >$startgridref</a></p>");
                                        if ($row['lat'] <>"") {
                                        print("<p><a href=\"http://maps.google.co.uk/?q=".$row['lat'].",".$row['lon']
                                        ."(See%20Description%20for%20departure%20details)&amp;z=16&amp;t=k\" target=\"_blank\">Satellite</a></p>");
                                        }
                                    
                                    print("<p>Map ".$row[exp]."</p>");
                                    print("</div>");

                                    //4th column of grid
                                    print("<div class=\"col-xs-6 col-md-4\"><p>".$row['longerdescription']."</p></div>");
